const questions = [
  ...
  { id: 'location', prompt: 'Où se trouve votre entreprise ?', options: ['Port-au-Prince', 'Delmas', 'Pétion-Ville', 'Carrefour', 'Croix-des-Bouquets', 'Cap-Haïtien', 'Gonaïves', 'Les Cayes', 'Jacmel', 'Jérémie', 'Saint-Marc', 'Hinche', 'Port-de-Paix', 'Ouanaminthe', 'Fort-Liberté', 'Mirebalais', 'Léogâne', 'Petit-Goâve', 'Miragoâne', 'Autre'] },
  ...
  { id: 'resources', prompt: 'De quel montant en gourdes avez-vous besoin pour réaliser votre projet ?', options: ['1 000 à 25 000 G', '25 000 à 50 000 G', '50 000 à 100 000 G', 'Plus de 100 000 G', 'Je ne sais pas encore', 'Autre'] },
